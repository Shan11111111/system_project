...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        // 將提案資料插入到募資專案表
        $fundraising_sql = "INSERT INTO fundraising_projects (suggestion_assignments_id, title, description, funding_goal, start_date, status) 
                            SELECT sa.suggestion_assignments_id, a.advice_title, sa.proposal_text, sa.funding_amount, NOW(), '進行中'
