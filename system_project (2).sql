...
(50, 412401011, '廁所施工聲音好吵', '請學校督促工人在課堂期間做好隔音', 1, 'equipment', '未處理', '2025-04-24'),
(51, 412401011, '輔仁醫院附近有變態', '我們發現輔仁醫院這裡有一位怪怪的老伯伯，他常來醫院附近和學生搭訕，我們覺得學校應該加強校安，希望可以加強校安人手。', 0, 'other', '未處理', '2025-04-24'),
(52, 412401011, '專題經費不足', '我們希望學校可以多給研究經費，尤其是我們要往更人工智慧發展，需要額外的金錢，我希望學校可以多給學生研究費用!尤其，教育部有給津貼，我覺得學校可以做更多的事情幫助學生更好!', 0, 'academic', '未處理', '2025-04-24'),
(53, 412401011, '捐血救人', '我們希望學校的捐血救人活動可以提供捐血一袋送禮物的活動', 1, 'welfare', '未處理', '2025-04-24'),
(54, 412401011, '請學校多宣傳捐血活動', '我們真的很需要有更多人捐血幫助血友症患者，我們希望學校能擴大宣傳或是幫助我們的活動實質的幫助!', 1, 'welfare', '未處理', '2025-04-24'),
(55, 412401011, '輔大應該積極推廣研究發展', '我認為學校應該提供更多經費幫助在研究計畫，例如織品系的紡織車不夠多，需要預約登記，時間不夠，無法在時間內完成。', 1, 'academic', '未處理', '2025-04-24'),
(56, 412401011, '輔大傳院跨國交流超炫!黃盟欽獲邀巴義兩國', '號外！號外！傳播學院獲獎喜訊不斷。創院以來第一人，影傳系藝術家黃盟欽老師遊走世界最前端，今年以新媒體科技結合影像創作，獲邀參加2024年10月15日在西班牙畢爾包舉辦的「BIDEODROMO國際實驗電影與錄影藝術節」，全台只有12位藝術家或團體參展。盟欽老師說：「能與來自世界各地的藝術家和觀眾交流，倍感榮幸與期待」。他不斷展現跨國藝術的交流能量，11月11日也獲邀到羅馬教廷參加我國駐教廷大使館主辦，由Sita Spada策展的「性靈相連」(Interconnected hearts) 數位藝術展，全台灣只有三人受邀。他以人工智慧對身體、科技和虛擬世界的影響，將數位人文與當代藝術融合，展現出科技與藝術的共融之美。簡直是超酷超炫的，輔大看似保守穩當，老師的靈魂一點都不保守。希望學校投入更多經費在傳播學院!', 1, 'academic', '未處理', '2025-04-24'),
(57, 412401011, '互動展覽經費補助', '我們希望學校能夠提供我們經費補助舉辦互動展覽，我們已經研發出來了互動展覽的展品，但因為手上的錢不夠租美術館，希望學校可以幫助我們!', 0, 'academic', '未處理', '2025-04-24'),
(58, 412401011, '舉辦下一次的社團展覽', '去年我們舉辦的社團展覽有很好的回響，今年需要一筆資金來籌辦社團展覽', 1, 'club', '未處理', '2025-04-24'),
(59, 412401011, '動漫電玩研習社的同學帶來活力四射的舞蹈', '動漫電玩研習社的同學帶來活力四射的舞蹈，請幫他們應援! 我們還需要100份應援球', 0, 'club', '未處理', '2025-04-24'),
...
--
ALTER TABLE `agree_record`
  MODIFY `agree_record_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
