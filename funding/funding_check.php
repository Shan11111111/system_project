...
$sql = "SELECT advice_id, advice_title, agree FROM advice WHERE agree >= 3 and advice_state='未處理'";
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>";
                        echo "<form action='process_funding.php' method='POST'>";
                        echo "<input type='hidden' name='advice_id' value='" . $row['advice_id'] . "'>";
                        echo "<input type='number' name='target' placeholder='輸入金額' required>";
                        echo "</td>";
                        echo "<td><button type='submit'>提交</button></form></td>";
                        echo "</tr>";
                    }
                } else {
                    echo "<tr><td colspan='5'>沒有符合條件的建言</td></tr>";
                }
                ?>
            </tbody>
        </table>
